...
[![Godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](http://godoc.org/elastic)
...
----------------------|------------------|------------
5.x                   | 5.0              | [`elastic`](https://elastic) ([source](https://github.com/olivere/elastic/tree/release-branch.v5) [doc](http://godoc.org/elastic))
