...
// method id "games.player_mem.get":
...
// Do executes the "games.player_mem.get" call.
...
// method id "games.player_mem.list":
...
// Do executes the "games.player_mem.list" call.
...
// set on the match with remaining slots for automatched player_mem.
...
func (c *TurnBasedMatchesLeaveTurnCall) Do(opts ...googleapi.CallOption) (*TurnBasedMatch, error) {
	...
	//       "description": "The ID of another participant who should take their turn next. If not set, the match will wait for other player(s) to join via automatching; this is only valid if automatch criteria is set on the match with remaining slots for automatched player_mem.",
	//       "location": "query",
	//       "type": "string"
	//     }
	//   },
