...
func init() {
	...
	// appKey = appcfg.GetString("rcloud_app_key", "")
	// appSecret = appcfg.GetString("rcloud_app_secret", "")

	// if appKey == "" || appSecret == "" {
	// 	panic("rcloud init failed")
	// }
}
 ...
 *@return TokenReslut
 */
func GetToken(userId string, name string, portraitUri string) (*TokenReslut, error) {
	if userId == "" {
