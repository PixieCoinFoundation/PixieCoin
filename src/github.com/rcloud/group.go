 ...
 */
func Create(userId []string, groupId string, groupName string) (*CodeSuccessReslut, error) {
	if len(userId) == 0 {
 ...
 *@return CodeSuccessReslut
 */
func Join(userId []string, groupId string, groupName string) (*CodeSuccessReslut, error) {
	if len(userId) == 0 {
		return nil, errors.New("Paramer 'userId' is required")
	}
 ...
 *@return CodeSuccessReslut
 */
func Quit(userId []string, groupId string) (*CodeSuccessReslut, error) {
	if len(userId) == 0 {
		return nil, errors.New("Paramer 'userId' is required")
	}
 ...
 *@return CodeSuccessReslut
 */
func Dismiss(userId string, groupId string) (*CodeSuccessReslut, error) {
	if userId == "" {
		return nil, errors.New("Paramer 'userId' is required")
	}
