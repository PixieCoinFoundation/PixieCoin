...
//
// Creates a multiplayer game session for player_mem. This action creates a game
...
//    a game session has reached its maximum number of player_mem. When searching
...
// reorders to get the best game play across all player_mem.
//
...
// also provide latency data for all player_mem. If successful, a new game session
...
type CreatePlayerSessionsOutput struct {
	...
	// Collection of player session objects created for the added player_mem.
...
type GameSession struct {
	...
	// Indicates whether or not the game session is accepting new player_mem.
...
type StartGameSessionPlacementInput struct {
	...
	// possible gameplay experience for the player_mem.
	PlayerLatencies []*PlayerLatency `type:"list"`
}
...
type UpdateGameSessionInput struct {
	...
	// Policy determining whether or not the game session accepts new player_mem.
	PlayerSessionCreationPolicy *string `type:"string" enum:"PlayerSessionCreationPolicy"`
